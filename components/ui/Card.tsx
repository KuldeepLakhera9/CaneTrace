...
export function CardHeader({
  ...
  return (
    <div
      className={cn("px-6 py-5 border-b border-slate-100 dark:border-slate-800/60", className)}
      {...props}
    >
      {children}
    </div>
...
export function CardFooter({
  ...
  return (
    <div
      className={cn(
        "px-6 py-4 bg-slate-50 dark:bg-slate-800/40 border-t border-slate-100 dark:border-slate-800/60 flex items-center justify-between",
        className
      )}
      {...props}
    >
